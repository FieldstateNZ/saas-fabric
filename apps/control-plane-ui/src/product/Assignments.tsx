 ...
 * changing the version, never by this control choosing one.
 *
 ...
 * the checkbox is left checked and a note explains the constraint instead of
 * quietly ignoring the click.
 */
          ...
          <section className="assignment" key={app.id}>
            <Check
              ...
              onChange={(checked) => {
                ...
                } else if (!locked.includes(app.id)) {
                ...
                <div className="form-grid">
                  <Select
                    ...
                    onChange={(version) => {
                      ...
                      const plan = selected?.definition.plans[0]
                      if (selected && plan) {
                        change({
                          ...assignment,
