...
use fabric_client_model::{ClientRevision, IdentityConfiguration, OidcClient, RealmName, RoleName};
...
impl IdentityResponse {
    /// Renders an identity configuration and its reconciliation state.
    pub(crate) fn new(
