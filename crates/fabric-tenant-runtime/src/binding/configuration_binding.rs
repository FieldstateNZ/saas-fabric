...
/// future sibling of the Data API (§27); this type exists now so that the
/// binding shape does not have to change when it arrives, and so a tenant
/// definition can already carry the information.
